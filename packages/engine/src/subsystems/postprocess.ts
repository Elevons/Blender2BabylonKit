...
/** Build and configure the DefaultRenderingPipeline (FXAA, bloom, image processing). */
...
): PostProcessingHandles
{
  ...
  {
    handles.pipeline = BuildDefaultPipeline(scene, targetCameras, postProcessingInfo);
  }
