 ...
 * own value. Directional suns also need a tight depth frustum (see directional.ts);
 * for point/spot a bit more normal bias compensates for their lower-precision
