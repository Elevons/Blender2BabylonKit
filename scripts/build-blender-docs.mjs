...
export const TRACES = [
  ...
  },
  {
    ...
    steps: [
      ...
      { file: "blender_addon/export/materials.py", symbol: "serialize_detail_maps", note: "EXPORT — copy packed detail map or pack separate channels to materials/; write manifest detailMaps[] (coordinatesIndex, uvScale, blend levels); export warnings on failure." },
