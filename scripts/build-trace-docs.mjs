...
export const TRACES = [
  ...
  },
  {
    ...
    steps: [
      ...
      { file: "blender_addon/export/materials.py", symbol: "serialize_detail_maps",
  ...
  },
  {
    ...
    steps: [
      ...
      { file: "packages/engine/src/subsystems/lights.ts", symbol: "FindLightForNode",
        note: "Walks the light parent chain (orientation-correction node may sit between GUID node and Light). Also searches lights moved into ClusteredLightContainer — required for runtime intensity scripts after clustering." },
